            ...
            <div class="infobox-warp">
                <div class="row gy-5 g-md-5">
                    ...
                    foreach( $content_topics as $content_topic ){
                        ...
                        <a href="<?= get_term_link($content_topic); ?>" class="col-md-6 col-lg-4 col-xl-3 text-decoration-none" <?= $topics_counter > $ppp ? 'style="display:none;"' : ''; ?> data-pagenumber="topics<?= ceil($topics_counter/$ppp); ?>">
