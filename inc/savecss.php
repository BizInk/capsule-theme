...
add_action('acf/options_page/save', 'capsule_save_options_page', 10, 2);
function capsule_save_options_page( $post_id, $menu_slug ) {
...
function capsule_update_completed( $upgrader_object, $options){
    if($options['action'] == 'update' && $options['type'] == 'theme'){
        process_scss();
    }
}
add_action( 'upgrader_process_complete', 'capsule_update_completed', 10, 2 );